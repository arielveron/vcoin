    ...
    return (
      <div>
        <div className="flex justify-between items-start mb-3">
          ...
          <div className="flex space-x-2">
            <button onClick={() => handleEdit(category)} className="text-indigo-600 p-1">
              <Edit className="h-5 w-5" />
            </button>
            <button onClick={() => handleDelete(category.id)} className="text-red-600 p-1">
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">{categories.length} categories • Manage visual styles and icons</p>
        </div>
        <button
          ...
          <div className="relative top-0 lg:top-10 mx-auto p-0 lg:p-5 border w-full lg:w-4xl h-full lg:h-auto shadow-lg lg:rounded-md bg-white">
            <div className="flex flex-col h-full lg:h-auto">
              <div className="flex items-center justify-between p-4 border-b lg:border-0">
                ...
                <button onClick={resetForm} className="lg:hidden p-2 text-gray-400 hover:text-gray-600">
                  <X className="h-5 w-5" />
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 lg:p-0 space-y-6">
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="space-y-4">
                    {/* First row: Font Size and Font Weight */}
                    ...
                    {/* Second row: Text Color and Premium Effect */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Text Color */}
                      <div>
                    ...
                    {/* Third row: Custom CSS - Full width */}
                    <div>
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="hidden" name="iconEffectClass" value={iconPreviewConfig.effectClass || ""} />
                    </div>
                  </div>
                  ...
                  {/* Icon Effects - New Section */}
                  <div className="mt-6">
                    <div>
                      <label htmlFor="iconEffectClass" className="block text-sm font-medium text-gray-700">
                        Icon Effect (Same as Text Effects)
                      </label>
                      <select
                        id="iconEffectClass"
                        value={iconPreviewConfig.effectClass || ""}
                        onChange={(e) => {
                          setIconPreviewConfig({
                            ...iconPreviewConfig,
                            effectClass: e.target.value,
                          });
                          if (iconPreviewConfig.name && iconPreviewConfig.library) {
                            setLiveFormData({
                              ...liveFormData,
                      ...
                      <p className="text-xs text-gray-500 mt-1">Apply the same premium effects to icons</p>
                    </div>
                  </div>
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">{liveFormData.level}</span>
                    </div>
