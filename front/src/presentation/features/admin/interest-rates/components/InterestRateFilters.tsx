/**
 * Interest Rate Filters Component
 * Handles filtering of interest rates by class
 */
'use client'
...
interface InterestRateFiltersProps {
  classes: Class[]
...
export default function InterestRateFilters({
  classes,
  filters,
  onFiltersChange,
  className = ""
}: InterestRateFiltersProps) {
  return (
